...
It attempts to match the current url like route does. its best used for when you dont need to actually render a route.
...
used to test from the beginning of a user experience to the end.
